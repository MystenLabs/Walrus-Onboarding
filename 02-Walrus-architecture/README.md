...
- **OR Local Setup**: Walrus CLI installed following the [Getting Started guide](https://docs.wal.app/docs/usage/started.md)
...
- [Developer Guide](https://docs.wal.app/docs/dev-guide/dev-operations.md)
