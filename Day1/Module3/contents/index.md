...
### 1. **[Component Duties](./component-duties.md)** (15-20 min)
...
### 2. **[Failure Modes](./failure-modes.md)** (15-20 min)
...
### 3. **[System Guarantees vs. Client Responsibilities](./guarantees.md)** (10-15 min)
...
### 6. **[Hands-On: Log Inspection](./hands-on.md)** (20-30 min)
...
Start with [Component Duties](./component-duties.md) to understand operational responsibilities, then proceed through each section in order. Complete the hands-on log inspection exercise to apply what you've learned.
