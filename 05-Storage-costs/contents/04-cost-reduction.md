...
📖 **Learn more:** [Quilt documentation](https://docs.wal.app/docs/usage/quilt.md) - implementation details and full cost savings table
...
- **Quilt for small blobs**: [Walrus Quilt](https://docs.wal.app/docs/usage/quilt.md) can reduce costs up to 409x for small files by sharing metadata overhead
