...
For more examples and use cases, see the [examples documentation](https://docs.wal.app/docs/usage/examples) and the [client CLI documentation](https://docs.wal.app/docs/usage/client-cli).
