...
1. Check the [Troubleshooting guide](https://docs.wal.app/docs/usage/troubleshooting.md)
...
5. Review the [client CLI documentation](https://docs.wal.app/docs/usage/client-cli.md) for additional usage details
