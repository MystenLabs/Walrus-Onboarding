...
- A Sui wallet with SUI and WAL tokens (see [Setup](https://docs.wal.app/docs/usage/setup) for details)


For more information on setting up your wallet and obtaining tokens, see the [Setup guide](https://docs.wal.app/docs/usage/setup#prerequisites).
