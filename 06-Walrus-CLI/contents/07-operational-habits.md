...
For a comprehensive guide to storage costs, cost optimization strategies, and understanding the different sources of cost, see the [costs documentation](https://docs.wal.app/docs/dev-guide/costs.md).
